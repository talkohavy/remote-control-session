...
type PromiseToastResult<Data = unknown> =
  string | React.ReactNode | ((data: Data) => React.ReactNode | string | Promise<React.ReactNode | string>);

type PromiseToastExtendedResultFn<Data = unknown> =
  PromiseToastExtendedResult | ((data: Data) => PromiseToastExtendedResult | Promise<PromiseToastExtendedResult>);
